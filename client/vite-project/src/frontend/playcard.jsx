...
export default function PlayCard({ name, id, health = 3, borderColor = 'blue' }) {
  ...
  return (
    <div className={`relative border-4 ${borderColors[borderColor]} h-full`}>
      <h2 className="absolute w-full text-white lg:text-base sm:text-xs text-[8px] font-bold z-50 px-3">{name} ({id})</h2>
